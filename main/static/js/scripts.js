...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const shiftBox = document.getElementById('global-shift');
    ...
    function handleCipherChange(val) {
        ...
        if (val === 'morse') {
            ...
            dInp1.classList.remove('hidden-data'); dInp2.classList.remove('hidden-data'); dInp3.classList.remove('hidden-data');
        ...
        [shiftBox, dCheck, dInp1, dInp2, dInp3].forEach(el => {
            if (el && !el.classList.contains('hidden-data')) {
...
window.zobrazUzel = function(folderName, nazev, ytUrl, popis) {
    ...
    detail.classList.remove('hidden-data');
